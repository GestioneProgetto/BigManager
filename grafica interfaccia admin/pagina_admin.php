...
<body>
  ...
  <div id="sfondo" class="sfondo">
    <div id="popup">
      <div class="text title">Modifica Prodotto</div><img class="img_popup" src="https://www.carrefour.it/on/demandware.static/-/Sites-carrefour-master-catalog-IT/default/dwb19da38e/large/GOCCIOLEALCIOCCOLATOPAVESI-8013355999143-5.png">
      <div id="prodotto">
        <form>
          <label>marca:</label>
  ...
  <div id="sfondo1" class="sfondo">
    <div id="popup">
      ...
      <img class="img_popup" src="https://www.carrefour.it/on/demandware.static/-/Sites-carrefour-master-catalog-IT/default/dwb19da38e/large/GOCCIOLEALCIOCCOLATOPAVESI-8013355999143-5.png">
      <div id="prodotto">
        <form>
          <label>marca:</label>
